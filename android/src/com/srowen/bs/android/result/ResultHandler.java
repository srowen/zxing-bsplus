 ...
 * @author Sean Owen
 */
public abstract class ResultHandler implements View.OnClickListener {
  ...
  public abstract Collection<Integer> getButtonIDsToShow();
  ...
  public abstract void handleClick(int buttonID);
