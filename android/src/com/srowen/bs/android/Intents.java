...
public final class Intents {
  ...
  /**
   * Constants related to the {@link Decode#ACTION} Intent.
   */
  public static final class Decode {
    /**
     * Send this intent to decode an image as a barcode. This follows semantics of the SEND or SENDTO
     * intent; either {@link android.content.Intent#getData()} should have a {@link android.net.Uri}
     * pointing to the image, or else the {@link android.content.Intent} should contain a
     * {@link android.net.Uri} extra under the key {@link android.content.Intent#EXTRA_STREAM}.
     */
    public static final String ACTION = "com.google.zxing.client.android.DECODE";
